...
/* ============================================================
   ...
   bg #FFFFFF · surface #FFFFFF · surface2 #F3F5F8
   turf(verde pasto) #1F3A5F · amber(caución) #D99A2B
   foul(alerta) #C8202F · chalk(texto) #16212E · muted #6B7785
...
function DiamondGauge({ pct, size = 84 }) {
  ...
  return (
    <div style={{ width: size, height: size, position: "relative", flexShrink: 0 }}>
        ...
        {bases.map((b) => {
          ...
          return (
            <rect
              ...
              fill={lit ? "#1F3A5F" : "#F3F5F8"}
              stroke={lit ? "#1F3A5F" : "#D7DCE3"}
              strokeWidth="1.5"
      ...
      >
        <span style={{ fontFamily: "Teko, sans-serif", fontSize: size * 0.3, fontWeight: 600, color: "#16212E", lineHeight: 1 }}>
          {clamped.toFixed(0)}%
        </span>
      </div>
    </div>
  ...
  return (
    ...
    >
      <style>{`
        ...
        .crm-scroll::-webkit-scrollbar-thumb { background: #D7DCE3; border-radius: 8px; }
        .crm-row:hover { background: #F3F5F8 !important; }
        ...
        .crm-input:focus, .crm-select:focus { outline: 2px solid #1F3A5F; outline-offset: 1px; }
      ...
      {/* Header */}
      <div style={{ padding: "22px 26px 0", borderBottom: "1px solid #E3E7ED" }}>
        <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", flexWrap: "wrap", gap: 10 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            <img src="/logo-bld.png" alt="BLD - Big League Dreams" style={{ height: 48, width: "auto", flexShrink: 0 }} />
            <div style={{ display: "flex", alignItems: "baseline", gap: 12 }}>
              <span style={{ fontFamily: "Teko, sans-serif", fontSize: 34, fontWeight: 700, letterSpacing: 0.5, color: "#1F3A5F", lineHeight: 1 }}>
                CRM BLD MEXICO
              </span>
              <span style={{ fontFamily: "IBM Plex Mono, monospace", fontSize: 12, color: "#6B7785" }}>
                Temporada 3 · 2026
              </span>
            </div>
          </div>
          <div style={{ display: "flex", gap: 18, fontFamily: "IBM Plex Mono, monospace", fontSize: 12, color: "#6B7785" }}>
            <span>Equipos activos <b style={{ color: "#16212E" }}>{state.teams.filter((t) => t.status !== "Fuera").length}</b></span>
            <span>Cupo total <b style={{ color: "#16212E" }}>{totals.comp}/{totals.capMax}</b></span>
          </div>
        </div>
          ...
          {TABS.map((t) => (
            <button
              ...
              style={{
                ...
                border: "none",
                borderBottom: tab === t.id ? "2.5px solid #1F3A5F" : "2.5px solid transparent",
                color: tab === t.id ? "#16212E" : "#6B7785",
                fontFamily: "Inter, sans-serif",
                fontWeight: 600,
                fontSize: 14,
      ...
      {toast && (
        <div
          style={{
            ...
            bottom: 20,
            right: 20,
            background: toast.type === "error" ? "#C8202F" : "#1F3A5F",
            color: "#FFFFFF",
            padding: "10px 16px",
            borderRadius: 8,
            fontFamily: "Inter, sans-serif",
...
function Dashboard({ scheduleStats, leagueStats, totals }) {
  return (
    <div>
        ...
        {scheduleStats.map((s) => (
          <div
            ...
            style={{
              ...
              alignItems: "center",
              gap: 14,
              boxShadow: "0 1px 3px rgba(22,33,46,0.06)",
            }}
          >
            <DiamondGauge pct={s.pctMax} />
            <div style={{ minWidth: 0 }}>
              <div style={{ fontFamily: "Teko, sans-serif", fontSize: 20, fontWeight: 600, color: "#16212E", lineHeight: 1.1 }}>
                {s.nombre}
              </div>
              <div style={{ fontFamily: "IBM Plex Mono, monospace", fontSize: 12, color: "#6B7785", marginTop: 4 }}>
                {s.completados} / {s.capacidadMaxima} equipos
              </div>
              <div style={{ fontFamily: "IBM Plex Mono, monospace", fontSize: 12, color: s.faltantes > 0 ? "#D99A2B" : "#1F3A5F", marginTop: 2 }}>
      ...
      <div style={{ fontFamily: "Teko, sans-serif", fontSize: 22, fontWeight: 600, marginBottom: 10, color: "#16212E" }}>
        Resumen por liga
      </div>
      <div className="crm-scroll" style={{ overflowX: "auto", border: "1px solid #E3E7ED", borderRadius: 10, boxShadow: "0 1px 3px rgba(22,33,46,0.06)" }}>
        <table style={{ width: "100%", borderCollapse: "collapse", fontFamily: "Inter, sans-serif", fontSize: 13 }}>
          <thead>
            <tr style={{ background: "#F6F8FA", textAlign: "left" }}>
              {["Liga", "Interesados", "Confirmados", "Pagados", "Nuevos", "Abonaron", "Sin abonar", "Fuera", "Total"].map((h) => (
                <th key={h} style={{ padding: "10px 12px", color: "#6B7785", fontWeight: 600, fontSize: 12, whiteSpace: "nowrap" }}>
                  {h}
                </th>
              ))}
            </tr>
          ...
          <tbody>
            {leagueStats.map((l) => (
              <tr key={l.id} className="crm-row" style={{ borderTop: "1px solid #E3E7ED" }}>
                ...
                <td style={{ padding: "10px 12px", fontFamily: "IBM Plex Mono, monospace", color: "#1F3A5F" }}>{l.pagados}</td>
                ...
                <td style={{ padding: "10px 12px", fontFamily: "IBM Plex Mono, monospace", color: l.sinAbonar > 0 ? "#C8202F" : "#6B7785" }}>{l.sinAbonar}</td>
...
function StatPill({ label, value, sub }) {
  return (
    <div style={{ background: "#FFFFFF", border: "1px solid #E3E7ED", borderRadius: 10, padding: "14px 16px", boxShadow: "0 1px 3px rgba(22,33,46,0.06)" }}>
      <div style={{ fontSize: 11, color: "#6B7785", fontWeight: 600, textTransform: "uppercase", letterSpacing: 0.5 }}>{label}</div>
      <div style={{ fontFamily: "Teko, sans-serif", fontSize: 30, fontWeight: 600, color: "#16212E", lineHeight: 1.2 }}>{value}</div>
...
function ExportModal({ tsv, onClose }) {
  ...
  return (
    <ModalShell title="Exportar equipos" onClose={onClose} width={640}>
      <p style={{ fontSize: 13, color: "#6B7785", marginTop: 0, marginBottom: 10 }}>
      ...
      <div style={{ display: "flex", justifyContent: "flex-end", gap: 10, marginTop: 12 }}>
        <button
          className="crm-btn"
          onClick={doCopy}
          style={{ background: "#1F3A5F", color: "#FFFFFF", border: "none", borderRadius: 8, padding: "9px 18px", fontWeight: 700, fontSize: 13, cursor: "pointer" }}
        >
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontFamily: "Inter, sans-serif", fontSize: 13, minWidth: 920 }}>
          ...
          <tbody>
            {filteredTeams.length === 0 && (
              <tr>
                <td colSpan={9} style={{ padding: "26px 12px", textAlign: "center", color: "#6B7785" }}>
            ...
            {filteredTeams.map((t) => {
              ...
              return (
                <tr key={t.id} className="crm-row" style={{ borderTop: "1px solid #E3E7ED", cursor: "pointer" }} onClick={() => openEdit(t)}>
                  <td style={{ padding: "10px 12px", fontWeight: 700 }}>
                    {t.nombreEquipo}
                    {t.nombreAnterior && t.nombreAnterior.toUpperCase() === "NUEVO" && (
                      <span style={{ marginLeft: 6, fontSize: 10, color: "#D99A2B", fontFamily: "IBM Plex Mono, monospace" }}>NUEVO</span>
                    )}
                  </td>
                  <td style={{ padding: "10px 12px", color: "#6B7785" }}>{l ? l.nombre : t.liga}</td>
                  ...
                  <td style={{ padding: "10px 12px", fontFamily: "IBM Plex Mono, monospace" }}>
                    {wa ? (
                      <a
                        ...
                        style={{ color: "#1F3A5F", display: "inline-flex", alignItems: "center", gap: 5, textDecoration: "none" }}
                      >
                        <IconWA /> {t.telManager}
                      </a>
                    ) : (
                  ...
                  <td style={{ padding: "10px 12px", color: "#6B7785" }}>Editar →</td>
                </tr>
              );
            })}
          </tbody>
...
function Field({ label, children }) {
  return (
    <label style={{ display: "block", marginBottom: 12 }}>
      <span style={{ display: "block", fontSize: 11, color: "#6B7785", fontWeight: 600, marginBottom: 5, textTransform: "uppercase", letterSpacing: 0.4 }}>
        {label}
      </span>
      {children}
    </label>
    ...
    >
      <div
        ...
        style={{
          ...
          overflowY: "auto",
          padding: 22,
          boxShadow: "0 20px 50px rgba(22,33,46,0.18)",
        }}
      >
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
          <span style={{ fontFamily: "Teko, sans-serif", fontSize: 24, fontWeight: 600, color: "#16212E" }}>{title}</span>
          <button onClick={onClose} style={{ background: "none", border: "none", color: "#6B7785", fontSize: 20, cursor: "pointer", lineHeight: 1 }}>×</button>
        </div>
        {children}
        {onDelete && (
          <button
            className="crm-btn"
            onClick={onDelete}
            style={{ marginTop: 6, background: "transparent", border: "1px solid #C8202F55", color: "#C8202F", borderRadius: 8, padding: "8px 14px", fontSize: 12, fontWeight: 600, cursor: "pointer" }}
          >
            Eliminar registro
          </button>
        )}
  ...
  return (
    <ModalShell title={isNew ? "Nuevo equipo" : "Editar equipo"} onClose={onClose} onDelete={isNew ? null : () => onDelete(team.id)}>
      ...
      <div style={{ display: "flex", justifyContent: "flex-end", gap: 10, marginTop: 8 }}>
        <button className="crm-btn" onClick={onClose} style={{ background: "transparent", border: "1px solid #D7DCE3", color: "#6B7785", borderRadius: 8, padding: "9px 16px", fontSize: 13, cursor: "pointer" }}>Cancelar</button>
        <button
          className="crm-btn"
          onClick={() => {
...
function Ligas({ leagues, schedules, updateLeague, updateSchedule, leagueStats }) {
  ...
  return (
    <div>
      ...
      <div className="crm-scroll" style={{ overflowX: "auto", border: "1px solid #E3E7ED", borderRadius: 10, marginBottom: 26, boxShadow: "0 1px 3px rgba(22,33,46,0.06)" }}>
          ...
          <thead>
            <tr style={{ background: "#F6F8FA", textAlign: "left" }}>
              {["Horario", "Capacidad máxima", "Mínimos"].map((h) => (
                <th key={h} style={{ padding: "10px 12px", color: "#6B7785", fontWeight: 600, fontSize: 12 }}>{h}</th>
              ))}
            </tr>
          </thead>
          <tbody>
            {schedules.map((s) => (
              <tr key={s.id} style={{ borderTop: "1px solid #E3E7ED" }}>
          ...
          <thead>
            <tr style={{ background: "#F6F8FA", textAlign: "left" }}>
              {["Liga", "Horario", "Inscripción", "Descuento", "A pagar", "En consumo", "Equipos"].map((h) => (
                <th key={h} style={{ padding: "10px 12px", color: "#6B7785", fontWeight: 600, fontSize: 12, whiteSpace: "nowrap" }}>{h}</th>
              ))}
            </tr>
          </thead>
          <tbody>
            {leagues.map((l) => {
              ...
              return (
                <tr key={l.id} style={{ borderTop: "1px solid #E3E7ED" }}>
                  ...
                  <td style={{ padding: "8px 12px", fontFamily: "IBM Plex Mono, monospace", color: "#1F3A5F" }}>{money(aPagar)}</td>
                  <td style={{ padding: "8px 12px", width: 120 }}>
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", gap: 10, flexWrap: "wrap", alignItems: "center", marginBottom: 12 }}>
        ...
        />
        <span style={{ fontSize: 12, color: "#6B7785", fontFamily: "IBM Plex Mono, monospace" }}>
          {filteredRows.length} de {rows.length}
        </span>
        <button
          className="crm-btn"
          onClick={openNew}
          style={{ marginLeft: "auto", background: "#1F3A5F", color: "#FFFFFF", border: "none", borderRadius: 8, padding: "9px 16px", fontWeight: 700, fontSize: 13, cursor: "pointer" }}
        >
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontFamily: "Inter, sans-serif", fontSize: 13, minWidth: 760 }}>
          ...
          <tbody>
            {filteredRows.length === 0 && (
              <tr>
                <td colSpan={8} style={{ padding: "26px 12px", textAlign: "center", color: "#6B7785" }}>
                  {rows.length === 0
            ...
            {filteredRows.map((r) => {
              ...
              return (
                <tr key={r.id} className="crm-row" style={{ borderTop: "1px solid #E3E7ED", cursor: "pointer" }} onClick={() => openEdit(r)}>
                  <td style={{ padding: "10px 12px", fontWeight: 600 }}>{r.manager}</td>
                  <td style={{ padding: "10px 12px", fontFamily: "IBM Plex Mono, monospace" }}>
                    {wa ? (
                      <a href={wa} target="_blank" rel="noreferrer" onClick={(e) => e.stopPropagation()} style={{ color: "#1F3A5F", display: "inline-flex", alignItems: "center", gap: 5, textDecoration: "none" }}>
                        <IconWA /> {r.telefono}
                      </a>
                    ) : "—"}
                  </td>
                  ...
                  <td style={{ padding: "10px 12px", color: "#6B7785", maxWidth: 200, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{r.observaciones}</td>
                  <td style={{ padding: "10px 12px", color: "#6B7785" }}>Editar →</td>
                </tr>
              );
            })}
